...
Forked from spikes/query2/catalog.py into e2e-pipeline (README.md D2 --
no live cross-spike import); see spikes/query2/q-approach4.md (Candidate
D) and mining-pass.md there for the full design writeup and the empirical
basis for it. Per the mining pass, every golden query in
spikes/query1/golden-answers.md is a contiguous sub-path of exactly two
chains:
